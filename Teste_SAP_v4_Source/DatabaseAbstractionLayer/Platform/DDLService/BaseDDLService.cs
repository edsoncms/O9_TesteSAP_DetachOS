...
namespace OutSystems.HubEdition.Extensibility.Data.Platform.DDLService {
    public abstract class BaseDDLService : IDDLService {
        ...
        public abstract bool CanAlterColumn(int existingColumnLengthFromOssysEntityAttribute,
                                            IPlatformTableSourceColumnInfo existingColumn, IPlatformTableSourceColumnInfo newColumn, out OutputMessage outputMessage);
        ...
        // existingColumnLengthFromOssysEntityAttribute parameter introduced because of RSAT-643 / RPD-2224 - HACK to avoid breaking change in Oracle when going form TEXT with exactly 2000 characters to anything bigger
        public abstract IEnumerable<string> AlterColumn(int existingColumnLengthFromOssysEntityAttribute,
                                                        IPlatformTableSourceColumnInfo existingColumn,
        ...
        public virtual bool AvoidTextMaxCharsBreakingChange(IPlatformTableSourceColumnInfo existingColumn, IPlatformTableSourceColumnInfo newColumn) {
            return false;
        }
    }
}
