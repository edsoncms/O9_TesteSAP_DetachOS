...
namespace OutSystems.HubEdition.RuntimePlatform {
    ...
    public class SessionInfo {
        ...
        private const string SESSION_FIXATION_PROTECTION_INSTANT = "SessionFixationProtectionInstant";
        ...
        // The user variables
        private volatile SessionHashtable _variables;
        ...
        public DateTime SessionFixationProtectionInstant {
            get {
                return _variables[SESSION_FIXATION_PROTECTION_INSTANT] == null ? DateTime.MinValue : Convert.ToDateTime(_variables[SESSION_FIXATION_PROTECTION_INSTANT]);
            }
            set {
                _variables[SESSION_FIXATION_PROTECTION_INSTANT] = value;
            }
    ...
    class SessionHashtable : ISerializable {
        ...
        private object Deserialize(byte[] data) {
            ...
            try {
                ...
                Log.ErrorLog.LogApplicationError("Error when deserializating session variable types. Session variables may assume empty values.", e.ToString(), AppInfo.GetAppInfo().OsContext, "RuntimePlatform");
                return null;
            } finally {
