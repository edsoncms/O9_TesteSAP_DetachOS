...
namespace OutSystems.HubEdition.RuntimePlatform {
    ...
    internal class DBRuntimePlatformSqlServer : DBRuntimePlatform {
        ...
        public override void GetDatabaseProviderAndVersion(out string database, out string version) {
            database = DatabaseAccess.ForCurrentDatabase.DatabaseServices.DatabaseConfiguration.DatabaseProvider.Properties.DisplayName;
            using (var trans = DatabaseAccess.ForCurrentDatabase.GetReadOnlyTransaction()) {
                using (var cmd = trans.CreateCommand("SELECT SERVERPROPERTY('productversion')")) {
