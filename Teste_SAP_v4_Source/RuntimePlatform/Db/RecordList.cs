...
namespace OutSystems.HubEdition.RuntimePlatform.Db {
    ...
    public abstract class OSList<T> : IOSList {
        ...
        public OSList(IDbTransaction trans)
            : this(trans, null) {
        }

        [Obsolete("Use the Default Constructor and set the Transaction afterwards.")]
        public OSList(IDbTransaction trans, ReadDBMethodDelegate alternateReadDBMethod)
            : this() {
            if (trans != null) {
                try {
    ...
    public class GenericRecordList<T> : OSList<T>, RecordList where T : ITypedRecord<T> {
        ...
        public GenericRecordList(IDisposable obj)
            : base(obj) {
        }
