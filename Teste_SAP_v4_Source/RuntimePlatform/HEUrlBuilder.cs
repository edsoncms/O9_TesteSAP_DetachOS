...
namespace OutSystems.HubEdition.RuntimePlatform
{
	...
	public class HEUrlBuilder {
		...
		public void Parse(Uri uri) {
            ...
            if (uri.Scheme == "http" && RuntimePlatformUtils.RequestIsSecure(HttpContext.Current.Request)) {
                _protocol = "https";
            }
			_server = uri.Host;
			_session = "";
		...
		public void Parse(HttpRequest request) {
			...
			try {
				...
				if ((s.StartsWith("/")) || (s.StartsWith("\\"))) {
					s = (RuntimePlatformUtils.RequestIsSecure(request) ? "https" : "http") + "://locahost" + s;
				} else {
					s = (RuntimePlatformUtils.RequestIsSecure(request) ? "https" : "http") + "://localhost/" + s;
				}
				u = new Uri(s);
			}
			Parse(u);
