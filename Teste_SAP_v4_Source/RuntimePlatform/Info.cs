...
namespace OutSystems.HubEdition.RuntimePlatform {
    ...
    public class SitePropertiesInfoReadOnly {
        ...
        protected class SiteProperty {
            ...
            public SiteProperty(object val)
                : this(0, null, true, val) {
            }
    ...
    public class EspaceProperties {
        ...
        public bool EspaceApplicationEnabled {
            get {
                return getPropWithCachedDefault<bool>("ApplicationEnabled", value => value.ToLower() == "true",
                    () => {
                        return RuntimePlatformUtils.IsApplicationEnabled(espaceId).ToString();
                    });
            }
        }
        ...
        public bool PerformanceMonitoringEnabled {
            get {
                return getPropWithCachedDefault<bool>("PerformanceMonitoringEnabled", value => value.ToLower() == "true", () => "false");
            }
        }
    ...
    public sealed class AppInfo {
        ...
        public string PtaName {
            get {
#if !JAVA
                // Avoid "Request is not available in this context errors during Application_Start. 
                // See http://mvolo.com/iis7-integrated-mode-request-is-not-available-in-this-context-exception-in-applicationstart/
