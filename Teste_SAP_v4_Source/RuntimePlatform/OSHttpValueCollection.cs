...
namespace OutSystems.HubEdition.RuntimePlatform
{
	internal class OSHttpValueCollection : System.Collections.Specialized.NameValueCollection {
		...
		internal OSHttpValueCollection(int capacity, string str) : this(capacity, str, false, false, RuntimePlatformUtils.DefaultEncoding) {} 
		internal OSHttpValueCollection(int capacity, string str, bool readOnly) : this(capacity, str, readOnly, false, RuntimePlatformUtils.DefaultEncoding) {} 
		...
		internal OSHttpValueCollection(string str) : this(str, false, false, RuntimePlatformUtils.DefaultEncoding) {} 
		internal OSHttpValueCollection(string str, bool readOnly) : this(str, readOnly, false, RuntimePlatformUtils.DefaultEncoding) {} 
		...
		internal virtual string ToString(bool urlencoded) {
			...
			while (local5 < local1) {
				...
				if (urlencoded)
					local2 = HttpUtility.UrlEncodeUnicode(local2);
				...
				if (local7 == 1) {
					...
					if (urlencoded)
						local4 = HttpUtility.UrlEncodeUnicode(local4);
