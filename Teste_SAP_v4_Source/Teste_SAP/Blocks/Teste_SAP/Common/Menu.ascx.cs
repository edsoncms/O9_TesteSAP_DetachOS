...
namespace ssTeste_SAP.Flows.FlowCommon {
	public abstract class WBlkMenu: OSUserControl, IWebScreen, INegotiateTabIndexes, IAjaxNotifyEvent, INotifyTriggers, INotifySender {
		...
		/// <summary>
		/// Screen Input Parameter inParamActiveSubMenuItemId. Description:
		/// </summary>
		public int inParamActiveSubMenuItemId = 0;
		...
		public static void GetCss(TextWriter writer, bool inline, HashSet<string> visited) {
			string blockId = "Teste_SAP.Ke77LnY3GBfWtQXGOyBElgw";
		...
		public ObjectKey Key {
			get {
				return ObjectKey.Parse("e77LnY3GBfWtQXGOyBElgw"); 
			}
		}
		...
		public override string WebBlockIdentifier {
			get {
				return "Teste_SAP.Ke77LnY3GBfWtQXGOyBElgw";
			}
		}
	}
