...
namespace ssTeste_SAP {
	...
	public sealed partial class ENMenuItemEntity {
		...
		public static string ViewName(int? tenant, string locale) {
			switch (locale == null ? "":
				...
				default:
					...
					return BaseAppUtils.EscapeAndQualifySqlIdentifier(DatabaseAccess.ForEspaceDatabase(94), "MenuItem48");
				}
			}
		} // ENMenuItemEntity
		...
		/// </summary>
		[OutSystems.HubEdition.RuntimePlatform.MetaInformation.EntityRecordDetails("MenuItem", "Entity5B57028B-F636-4BA3-93F9-C81CACBC5638", "N2UIQTt6+k6ug6JI4E9zoQ", 0, "MenuItem48", null)]
		[Serializable()]
		public partial struct ENMenuItemEntityRecord: ISerializable, ITypedRecord<ENMenuItemEntityRecord>, ISimpleRecord {
			private static readonly GlobalObjectKey IdId = GlobalObjectKey.Parse("N2UIQTt6+k6ug6JI4E9zoQ*R33XWJvSxw4LUkh9JfGD+w");
			private static readonly GlobalObjectKey IdOrder = GlobalObjectKey.Parse("N2UIQTt6+k6ug6JI4E9zoQ*yjbSVyRHeQj+bINsKjLKzQ");
			private static readonly GlobalObjectKey IdCaption = GlobalObjectKey.Parse("N2UIQTt6+k6ug6JI4E9zoQ*h638tE3zOU6SFAHeugbmxQ");
		...
		partial class ENMenuItemEntity: StaticEntityRuntime {
			...
			private static ENMenuItemEntity instance = new ENMenuItemEntity(94, ObjectKey.Parse("Entity5B57028B-F636-4BA3-93F9-C81CACBC5638"));
		...
		public partial struct RCMenuItemRecord: ISerializable, ITypedRecord<RCMenuItemRecord> {
			private static readonly GlobalObjectKey IdMenuItem = GlobalObjectKey.Parse("2UmDmepsh0WSfJ_D1JexCA*dBG53l3tdN4s0rlsS3IXlQ");
