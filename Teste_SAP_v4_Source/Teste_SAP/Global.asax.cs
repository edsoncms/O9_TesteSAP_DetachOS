...
namespace ssTeste_SAP {
	...
	public class Global: System.Web.HttpApplication {
		...
		static Global() {
			// Log
			OutSystems.RuntimeCommon.Log.EventLogger.SetUp(OutSystems.RuntimeCommon.Log.EventLogger.DefaultSource, "Message generated by eSpace Teste_SAP.");
			// Late load
		...
		protected static object GetSessionDefault(string varName) {
			if (varName == "UserName")
			return "";
			if (varName == "Teste_SAP.LoginRedirectURL")
			return "";
		...
		private void InitializeComponent() {
			lock(_initLock) {
				if (!_initialized) {
					RuntimeLogger.SetUp("eSpace Teste_SAP", true);
		...
		protected void Application_Start(Object sender, EventArgs e) {
			try {
				...
				Application["EspaceName"] = "Teste_SAP";
				...
				FormatInfo.SetDefaultDateAndDateTimeFormatString("d/M/yyyy", "dd/MM/yyyy");
				...
				eSpaceInfo.ESpaceName = "Teste_SAP";
				eSpaceInfo.ESpaceId = eSpaceId;
				eSpaceInfo.ESpaceVersionId = 890;
		...
		protected void Application_AcquireRequestState(Object sender, EventArgs e) {
			...
			RunningInfo.ESpaceHash = "bZICXtXHldKy1hMhiAWhgA";
			RunningInfo.ESpaceVersionId = 890;
		...
		protected void Application_BeginRequest(Object sender, EventArgs e) {
			...
			if (App != null) {
				RequestTracer perfTracer = new RequestTracer(App.ApplicationUID, App.ApplicationName, App.eSpaceUID, App.eSpaceName,
				App.Tenant.Id_Guid, App.Tenant.Name, App.EnvironmentKey, App.EnvironmentName, App.FrontendName);
				perfTracer.RegisterBeginRequest(DateTime.Now);
				App.OsContext.RequestTracer = perfTracer;
		...
		public static string GetStringResource(string key, string defaultValue) {
			...
			if (embeddedResourceManager == null) {
				lock(embeddedResourceManagerLock) {
					if (embeddedResourceManager == null) {
						string baseResourceName = "Teste_SAP" + "Language";
