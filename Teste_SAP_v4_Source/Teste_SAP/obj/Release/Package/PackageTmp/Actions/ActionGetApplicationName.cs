...
namespace ssTeste_SAP {
	...
	public partial class Actions {
		/// <summary>
		/// Action <code>ActionGetApplicationName</code> that represents the Service Studio reference action
		...
		public static void ActionGetApplicationName(HeContext heContext, int inParamESpaceId, out string outParamApplicationName) {
			RsseSpaceRichWidgets.MssGetApplicationName(heContext, inParamESpaceId, out outParamApplicationName);
		}
