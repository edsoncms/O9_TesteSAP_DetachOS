...
namespace ssTeste_SAP.Flows.FlowCommon {
	public abstract class WBlkHeader: OSUserControl, IWebScreen, INegotiateTabIndexes, IAjaxNotifyEvent, INotifyTriggers, INotifySender {
		...
		/// </summary>
		protected OutSystems.HubEdition.WebWidgets.HyperLink wt_Link5;
		...
		public static void GetCss(TextWriter writer, bool inline, HashSet<string> visited) {
			string blockId = "Teste_SAP.KgGqVjlDuvkKTxk7naaerTA";
		...
		private static void InnerGetCss(TextWriter writer, bool inline, HashSet<string> visited) {
			ssTeste_SAP.Flows.FlowCommon.WBlkLoginInfo.GetCss(writer, inline, visited);
		}
		...
		public ObjectKey Key {
			get {
				return ObjectKey.Parse("gGqVjlDuvkKTxk7naaerTA"); 
			}
		}
		...
		public void webBlck_WebBlockInstance6_onDataBinding(object sender, System.EventArgs e) {
			...
			try {
				heContext.CurrentESpaceId = ssTeste_SAP.Global.eSpaceId;
				ssTeste_SAP.Flows.FlowCommon.WBlkLoginInfo widget = (ssTeste_SAP.Flows.FlowCommon.WBlkLoginInfo) sender;
			} finally {
				heContext.CurrentESpaceId = oldCurrentESpaceId;
			}
		}
		...
		/// <summary>
		/// Gets the Navigate URL for the link of variable (wt_Link5)
		/// </summary>
		/// <returns>The Navigate URL of the link variable (wt_Link5)</returns>
		public string lnk_Link5_NavigateUrl() {
			String varLcinParamURL = "";
			varLcinParamURL = AppUtils.Instance.getImagePath();
			string sURL = varLcinParamURL;
			sURL = sURL.Replace("&amp;", "&");
		...
		/// <summary>
		/// Function to dump expression (Key = 3lRuAOM9b0KXAtWoveGj3g) Expression:
		///  GetApplicationName(GetOwnerEspaceIdentifier)
		/// </summary>
		/// <returns>Returns the value of the Expression</returns>
		public string expression_InlineExpression1() {
			return Functions.rssespacerichwidgets_ActionGetApplicationName(heContext, AppUtils.CurrentEspaceId);
		}
		...
		public override string WebBlockIdentifier {
			get {
				return "Teste_SAP.KgGqVjlDuvkKTxk7naaerTA";
			}
		}
	}
