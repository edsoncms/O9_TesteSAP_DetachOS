...
namespace ssTeste_SAP.Flows.FlowCommon {
	...
	public class ScrnInvalidPermissions: OSPageViewStateCompressed, IWebScreen, INegotiateTabIndexes, IBookmarkableURL {
		...
		public ScrnInvalidPermissions(): base(Teste_SAP_Properties.QuirksMode) {
		}


		/// <summary>
		/// Variable RichWidgets_wt_WebBlockInstance5
		/// </summary>
		protected proxy_Teste_SAP_RichWidgets.Flows.FlowLayouts.WBlkLayout_London RichWidgets_wt_WebBlockInstance5;
		...
		protected string GetRequestInfoJavaScript() {
			return GetRequestInfoJavaScript("ENYWxFeUa0qGzxz3NZDQWg", "InvalidPermissions");
		}
		...
		protected string GetHeadTopJavaScript() {
			return GetInjectedCode(CodeInjectionFactory.Locations.HeadTop, "ENYWxFeUa0qGzxz3NZDQWg", "InvalidPermissions");
		}

		protected string GetHeadBottomJavaScript() {
			return GetInjectedCode(CodeInjectionFactory.Locations.HeadBottom, "ENYWxFeUa0qGzxz3NZDQWg", "InvalidPermissions");
		}

		protected string GetBodyTopJavaScript() {
			return GetInjectedCode(CodeInjectionFactory.Locations.BodyTop, "ENYWxFeUa0qGzxz3NZDQWg", "InvalidPermissions");
		}

		protected string GetBodyBottomJavaScript() {
			return GetInjectedCode(CodeInjectionFactory.Locations.BodyBottom, "ENYWxFeUa0qGzxz3NZDQWg", "InvalidPermissions");
		}
		...
		private void InitializeComponent() {
			RichWidgets_wt_WebBlockInstance5 = (proxy_Teste_SAP_RichWidgets.Flows.FlowLayouts.WBlkLayout_London) FindControl("RichWidgets_wt_WebBlockInstance5");
		...
		public override Control FindControl(string id) {
			if (id == "wt_WebBlockInstance10") {
				return RichWidgets_wt_WebBlockInstance5.wtHeader.FindControl("wt_WebBlockInstance10");
			}
			if (id == "wt_WebBlockInstance1") {
				return RichWidgets_wt_WebBlockInstance5.wtMenu.FindControl("wt_WebBlockInstance1");
			}
			if (id == "wt_Text13") {
				return RichWidgets_wt_WebBlockInstance5.wtTitle.FindControl("wt_Text13");
			}
			if (id == "wt_Text12") {
				return RichWidgets_wt_WebBlockInstance5.wtMainContent.FindControl("wt_Text12");
			}
			if (id == "wt_WebBlockInstance11") {
				return RichWidgets_wt_WebBlockInstance5.wtFooter.FindControl("wt_WebBlockInstance11");
			}
		...
		private void Page_Load(object sender, System.EventArgs e) {
			...
			if (appInfo != null) {
				heContext = appInfo.OsContext; heContext.RequestTracer.MainEventType = RequestTracerEventType.WebScreenServerExecuted; heContext.RequestTracer.RegisterEndpoint("c416d610-9457-4a6b-86cf-1cf73590d05a", "InvalidPermissions"); 
			}
			OutSystems.HubEdition.RuntimePlatform.Web.JavaScriptManager.CheckRelativeJavaScriptPrefix(AppUtils.Instance.getImagePath());
			appInfo.IsLoadingScreen = !IsPostBack;
			if (!IsPostBack) {
				ArrayList screenParameters = (ArrayList) Global.App.OsContext.Session["Teste_SAP._ScreenParameters_InvalidPermissions"];
				...
				if ((screenParametersKey == null || this.Key.Equals(ObjectKey.Parse(Convert.ToString(screenParametersKey)))) && screenParameters != null) {
					try {
						...
						Global.App.OsContext.Session["Teste_SAP._ScreenParameters_InvalidPermissions"] = null;
			...
			if (!IsPostBack) {
				...
				if (!heContext.AppInfo.SelectiveLoggingEnabled || heContext.AppInfo.Properties.AllowLogging) {
					ScreenLog.StaticWrite(heContext.StartInstant, (int) ((TimeSpan) (DateTime.Now-heContext.StartInstant)).TotalMilliseconds, "InvalidPermissions", heContext.Session.SessionID, heContext.AppInfo.eSpaceId, heContext.AppInfo.Tenant.Id, heContext.Session.UserId, (string) heContext.Session["MSISDN"], "WEB", "Screen", Environment.MachineName, RuntimePlatformUtils.GetViewstateSize(), RuntimePlatformUtils.GetRetrievedSessionSize(), RuntimePlatformUtils.GetRetrievedSessionRequests());
				}
			} else {
		...
		public ObjectKey Key {
			get {
				return ObjectKey.Parse("ENYWxFeUa0qGzxz3NZDQWg"); 
			}
		}
		...
		public void doAJAXRefreshScreen(HeContext heContext) {
			...
			try {
				...
				if (!heContext.AppInfo.SelectiveLoggingEnabled || heContext.AppInfo.Properties.AllowLogging) {
					ScreenLog.StaticWrite(heContext.StartInstant, (int) ((TimeSpan) (DateTime.Now-heContext.StartInstant)).TotalMilliseconds, "InvalidPermissions", heContext.Session.SessionID, heContext.AppInfo.eSpaceId, heContext.AppInfo.Tenant.Id, heContext.Session.UserId, (string) heContext.Session["MSISDN"], "WEB", "Ajax", Environment.MachineName, RuntimePlatformUtils.GetViewstateSize(), RuntimePlatformUtils.GetRetrievedSessionSize(), RuntimePlatformUtils.GetRetrievedSessionRequests());
				}
			} finally {
				heContext.CurrentESpaceId = oldCurrentESpaceId;
			}
