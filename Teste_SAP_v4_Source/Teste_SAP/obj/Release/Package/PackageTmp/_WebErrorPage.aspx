	...
	if (heContext != null && heContext.AppInfo != null && !heContext.AppInfo.Properties.RemoteShowStack){
		...
		if(!isLocal) {
            ...
            if (heContext.IsAjaxRequest) {
                // AJAX Redirect...
                if (url != null && url != "") {
                    OSPageViewState.WriteAJAXClientRedirectResponse(heContext.Context.Request, heContext.Context.Response, url, "Teste_SAP");
                } else {
                    OSPageViewState.WriteAJAXClientRedirectResponse(heContext.Context.Request, heContext.Context.Response, "/customHandlers/internalerror.aspx", "Teste_SAP");
                }
                ajaxRedirected = true;
            } else {
                // Submit redirect...
